...
func (u *User) setIceInfo(offerIce, answerIce *util.SdpIceAttr, candidates []string) bool {
...
func (u *User) getSendIce() util.SdpIceAttr {
	return u.sendIce // from answer
}

func (u *User) getRecvIce() util.SdpIceAttr {
